...
public class BlackjackControllerBasic {
	private Deck deck; // Bộ bài
	private Playerofblackjack player; // Người chơi
	private Playerofblackjack dealer; // Nhà cái
	...
	private void resetGame() {
		...
		player = new Playerofblackjack("Player");
		dealer = new Playerofblackjack("Dealer");
